...
- ✅ **Multiple Choice**: 4 answer options (1 correct, 3 wrong)
...
- 🎵 **Sound Effects**: Simple audio feedback for correct/wrong answers
...
- **Wrong Answers**: Generated by adding/subtracting 1-15 from correct answer
